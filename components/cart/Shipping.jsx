...
const Shipping = ({ addresses }) => {
  ...
  const [shippingInfo, setShippinInfo] = useState("");
  const [addressInfo, setsetAddressData] = useState("");
  const [addressInfoone, setsetAddressDataone] = useState("");
  const [addressInfotwo, setsetAddressDatatwo] = useState("");
  const [addressInfothree, setsetAddressDatathree] = useState("");
  const [addressInfofour, setsetAddressDatafour] = useState("");
  const [addressInfofive, setsetAddressDatafive] = useState("");


  const setShippingAddress = (address) => {
    
    setShippinInfo(address._id);
    setsetAddressData(address.street)
    setsetAddressDataone(address.city) 
    setsetAddressDatatwo(address.state) 
    setsetAddressDatathree(address.zipcode) 
    setsetAddressDatafour(address.country)
    setsetAddressDatafive(address.phoneNo)
      ...
      <section className="py-10 bg-gray-50">
        <div className="container max-w-screen-xl mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-4 lg:gap-8">
            ...
            <main className="md:w-2/3">
              <article className="border border-gray-200 bg-white shadow-sm rounded p-4 lg:p-6 mb-5">
                <h2 class="text-xl font-semibold mb-5">Biiling information</h2>
                ...
                <div class="grid sm:grid-cols-2 gap-4 mb-6">
                    ...
                    >
                      ...
                      <p class="ml-2">
                        ...
                        <small class="block text-sm text-gray-400">
                        {addressInfoone} &nbsp;{addressInfotwo} &nbsp;{addressInfothree}
                          <br />
                          {addressInfofour}
                          <br />
                          {addressInfofive}
