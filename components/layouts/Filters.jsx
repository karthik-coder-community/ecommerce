  ...
  <li>
    <label className="flex items-center">
      <input
        ...
        value="Male"
        className="h-4 w-4"
        defaultChecked={checkHandler("gender", "Male")}
  ...
  <li>
    <label className="flex items-center">
      <input
        ...
        value="Female"
        className="h-4 w-4"
        defaultChecked={checkHandler("gender", "Female")}
        onClick={(e) => handleClick(e.target)}
      />
          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Watches"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Watches")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Watches </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Shoes"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Shoes")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Shoes </span>
            </label>
          </li>
        </ul>
